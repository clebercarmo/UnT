...
func setupUpdate() ([]string, dto.UpdateFeiraRequest, domain.Feira, pgxmock.PgxPoolIface) {
...
func TestUpdate(t *testing.T) {
	cols, fakeFeiraRequest, fakeFeiraDBResponse, mock := setupUpdate()
	defer mock.Close()
	...
	feira, err := sut.Update(&fakeFeiraRequest)
...
func TestUpdate_DBError(t *testing.T) {
	_, fakeFeiraRequest, _, mock := setupUpdate()
	defer mock.Close()
